...
class Gaussion_Transition_Model(nn.Module):
    """
    NN_Transition_Model_with_Gaussion_Output
    """

    def __init__(self, in_channels, out_channels, obs_scale, global_graph_width=64, traj_pred_mlp_width=64):
        super(Gaussion_Transition_Model, self).__init__()
